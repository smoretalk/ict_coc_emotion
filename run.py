...
load_path = '/home/hschung/speech/Speech-Emotion-Recognition-ROS/resnet_saved_model.pt'
...
class Predictor(object):
    def __init__(self, model, device ='cpu',  fp16=False ):
        ...
        self.cls_name = {0:'상처', 1:'기쁨', 2:'불안', 3:'당황', 4:'분노', 5:'슬픔'}
        self.device = device
...
def speech_to_text(tmp_filename, model_size):
    ...
    result = model_whisper.transcribe(tmp_filename)
    file = tmp_filename
    predictor = Predictor(model)
    emotion = "Classified Emotion:" + predictor.predict(file)
